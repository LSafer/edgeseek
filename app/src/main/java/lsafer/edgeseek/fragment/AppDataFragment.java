...
/**
 * A fragment to edit the data of the application.
 *
 * @author lsafer
 * @version 0.1.5
 * @since 27-May-20
 */
public class AppDataFragment extends PreferenceFragmentCompat {
	/**
	...
	public void onCreate(@Nullable Bundle savedInstanceState) {
		if (this.getActivity() instanceof Activity)
			this.data = ((Activity) this.getActivity()).getAppData(this);
		else throw new IllegalArgumentException("Illegal Owner, not implementing AppDataFragment.Activity");
	...
	public interface Activity {
		/**
		 * Returns the app-data instance that should be used by the fragment.
		 *
		 * @param fragment the fragment that have requested the data
		 * @return the app-data instance of the
		 * @throws NullPointerException if the given fragment is null
		 */
		AppData getAppData(AppDataFragment fragment);
	}
}
